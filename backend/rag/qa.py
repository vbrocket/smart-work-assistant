...
6. هام جداً: إذا وجدت جداول في السياق (تبدأ بـ "جدول:")، ابحث فيها عن القيم المطلوبة. إذا سأل المستخدم عن درجة أو رقم معين، ابحث عنه في كل صف من صفوف الجدول واستخرج القيمة المقابلة. لا تتجاهل أي جدول. إذا وجدت مرادفات بين قوسين بجانب المسمى الوظيفي في الجدول، استخدمها لمطابقة ما يقوله المستخدم مع الصف الصحيح. انتبه: لا تخلط بين صفوف مختلفة — طابق المسمى الوظيفي المذكور من المستخدم مع الصف الذي يحتويه أو يحتوي مرادفه بالضبط، ثم أعطِ القيمة من نفس الصف فقط.
...
5. هام جداً: إذا وجدت جداول في السياق، ابحث فيها عن القيم المطلوبة. إذا سأل المستخدم عن درجة أو رقم معين، ابحث عنه في الجدول واستخرج القيمة المقابلة. إذا وجدت مرادفات بين قوسين بجانب المسمى الوظيفي، استخدمها لمطابقة ما يقوله المستخدم مع الصف الصحيح. انتبه: لا تخلط بين صفوف مختلفة — طابق المسمى بالضبط ثم أعطِ القيمة من نفس الصف فقط.
