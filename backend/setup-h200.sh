#!/usr/bin/env bash
#
# setup-h200.sh — Validate environment, stop conflicting services,
...
# ─────────────────────────────────────────────────────────────────────────
# Configuration — single GPU, all on GPU 0
# ─────────────────────────────────────────────────────────────────────────
...
echo ""
info "━━━ LLM Smoke Test (single GPU, TP=1) ━━━"
...
echo ""
echo "  ┌─────────────────────────────────────────────────────────────┐"
echo "  │  GPU Assignment — H200 NVL single GPU (verified)            │"
echo "  ├───────┬────────────────────────────────┬───────┬────────────┤"
