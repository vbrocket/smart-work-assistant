#!/usr/bin/env bash
#
# setup-h200.sh â€” Validate environment, stop conflicting services,
# install dependencies, download models, and run smoke tests on vast.ai.
#
# Designed for: 1x NVIDIA H200 NVL (~141 GB VRAM)
# All models share GPU 0 â€” no tensor parallelism needed.
#
# GPU layout (single GPU):
#   GPU 0 â†’ LLM       (Qwen3-32B)             port 8001  (70%)
...
#   chmod +x setup-h200.sh
#   ./setup-h200.sh
#
set -euo pipefail

# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# Configuration â€” single GPU, all on GPU 0
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
if [ "${GPU0_USED:-0}" -lt 1000 ]; then
    pass "GPU 0 is free (${GPU0_USED}MB used)"
else
    warn "GPU 0 still has memory in use (${GPU0_USED}MB)"
...
if ! command -v nvidia-smi &>/dev/null; then
    ...
    if [ "$GPU_COUNT" -ge "$MIN_GPUS" ]; then
        ...
        fail "GPUs detected: $GPU_COUNT (need >= $MIN_GPUS)"
    fi
    ...
    echo ""
    info "GPU assignment plan (single GPU â€” all on GPU 0):"
    info "  GPU $LLM_GPU    â†’ LLM ($LLM_MODEL) on port $LLM_PORT"
    info "  GPU $ROUTER_GPU â†’ Router ($ROUTER_MODEL) on port $ROUTER_PORT"
    ...
    info "  GPU 0           â†’ Whisper + TTS (in-process, shared)"
fi
...
echo ""
info "â”â”â” LLM Smoke Test (single GPU, TP=1) â”â”â”"
if smoke_test_vllm "$LLM_MODEL" "generate" "$LLM_PORT" "$LLM_GPU" "LLM" "0.70" "32768" "bfloat16" "1"; then
...
if smoke_test_vllm "$EMBED_MODEL" "embed" "$EMBED_PORT" "$EMBED_GPU" "Embedding" "0.10" "8192" "float16"; then
...
if smoke_test_vllm "$RERANK_MODEL" "score" "$RERANK_PORT" "$RERANK_GPU" "Reranker" "0.05" "512" "float16"; then
...
echo ""
info "â”â”â” Router LLM Smoke Test â”â”â”"
...
if [ "$FAIL" -gt 0 ]; then
    echo -e "  ${RED}There were failures. Review the output above before running deploy-h200.sh${NC}"
    echo ""
...
echo "  â”‚  GPU Assignment â€” H200 NVL single GPU (verified)            â”‚"
echo "  â”œâ”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤"
...
printf "  â”‚  %-4s â”‚  %-30sâ”‚  %-4s â”‚  %-9s â”‚\n" "0" "Whisper ($WHISPER_MODEL)" "â€”" "in-process"
echo "  â””â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜"
echo ""
echo "  Next steps:"
echo "    1. cp .env.vastai .env   (if not already done)"
echo "    2. ./deploy-h200.sh     (starts all services)"
echo ""
